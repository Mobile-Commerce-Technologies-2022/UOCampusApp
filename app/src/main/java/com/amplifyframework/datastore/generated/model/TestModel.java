...
@ModelConfig(pluralName = "TestModels", authRules = {
...
public final class TestModel implements Model {
  ...
  public static final QueryField NAME = field("TestModel", "name");
  ...
  private TestModel(String id, String name) {
    this.id = id;
    this.name = name;
  }
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      return ObjectsCompat.equals(getId(), testModel.getId()) &&
              ObjectsCompat.equals(getName(), testModel.getName()) &&
